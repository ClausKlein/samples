...
int main()
{
    ...
    if (is) {
        ...
        // FIXME warning: implicit conversion loses integer precision: 'off_t'
        // (aka 'long long') to 'streamsize' (aka 'int') [-Wshorten-64-to-32]
    ...
    }
    {
        ...
        std::cout << std::cin.gcount() << " characters read: " << buf
                  << std::endl;
    }
    return 0;
}
